...
public class Gun : MonoBehaviour
{
    ...
    public void Shoot()
    {
        ...
        {
            ProjectileServer.Spawn(player, type, transform.position, transform.forward * shotSpeed * Time.fixedDeltaTime);
            loadedAmmo--;
            SendAmmoUpdated();
        }
    }
    ...
    {
        Message message = Message.Create(MessageSendMode.Reliable, MessageId.playerAmmoChanged);
